...
{
    internal class PicklistColumnConverter : AttributeToColumnConverterBase
    {
        public override AttributeTypeDisplayName[] AttributeTypeFilter()
        {
            return new AttributeTypeDisplayName[]
            {
                AttributeTypeDisplayName.PicklistType,
                AttributeTypeDisplayName.StateType,
                AttributeTypeDisplayName.StatusType
            };
        }
