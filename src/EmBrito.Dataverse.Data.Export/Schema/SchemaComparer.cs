...
namespace EmBrito.Dataverse.Data.Export.Schema
{
    public class SchemaComparer
    {
        ...
        readonly IEnumerable<TableDefinition> local;
        readonly IEnumerable<TableDefinition> remote;
        ...
        public SchemaComparer(IEnumerable<TableDefinition> localDefinitions, IEnumerable<TableDefinition> remoteDefinitions)
        {
        ...
        TableSchemaChanges GetSchemaChanges(TableDefinition localTable, TableDefinition remoteTable)
        {
            ...
            var changes = new TableSchemaChanges(localTable);
