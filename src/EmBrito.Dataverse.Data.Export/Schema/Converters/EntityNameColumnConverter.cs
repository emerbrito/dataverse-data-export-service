...
{
    internal class EntityNameColumnConverter : AttributeToColumnConverterBase
    {
        ...
        public override AttributeTypeDisplayName[] AttributeTypeFilter()
        {
            ...
            {
                AttributeTypeDisplayName.EntityNameType
            };
        }

        protected override ColumnDefinition? Convert(AttributeMetadata attributeMetadata, EntityMetadata entityMetadata)
        {
            return ColumnDefinitionFactory.CreateString(attributeMetadata.LogicalName, 128);
        }
    }
}
